###############################################################################
##Mission Description : Plot multi chart 2x2 scatter plots                   ##
###############################################################################
## Pre-Load Packages
library(graphics)
library(ggplot2)
...
##Plot : Top-Right
with(my_df,plot(Time,Voltage, type="l",ylab="Voltage",cex.lab=0.7,cex.axis=0.7))
##Plot : Bottom-Left
...
legend("topright",col=c("black","red","blue"),
       legend=c("Sub_metering_1","Sub_metering_2", "Sub_metering_3"),cex=0.5, lty=1, lwd=1)
##Plot : Bottom-Right
with(my_df,plot(Time,Global_reactive_power, type="l",ylab="Global_reactive_power",cex.lab=0.7,cex.axis=0.7))
